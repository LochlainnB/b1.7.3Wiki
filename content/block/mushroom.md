...
code, so they behave mostly identically; they differ in appearance, in how often they
...
In the [[Overworld|overworld]] a chunk gets one brown attempt in four and one red attempt in
eight, and the [[Sky|sky]] dimension uses the same rates. In the [[Nether|nether]] both kinds run
in every chunk, which is why [[Netherrack|netherrack]] caverns are thick with them.
...
is [[Air|air]], and so not [[Water|water]], not [[Tall Grass|tall grass]] and not a [[Snow|snow]] layer; the block
directly below fills its whole cube and blocks light; and the light in the space
is 12 or less.

The ground rule is unusually broad. Other small plants accept only [[Grass|grass]],
[[Dirt|dirt]] and [[Farmland|farmland]], but a mushroom asks a different question of the block
below it — whether it is a full opaque cube. Nearly every solid block passes,
[[Stone|stone]], ores, [[Wool|wool]], and [[Wooden Planks|planks]] alike, and so do [[Leaves|leaves]] and the
[[Double Stone Slab|double stone slab]]. Blocks that do not fill their cube all fail, among them
the [[Stone Slab|stone slab]], stairs, [[Fence|fences]], [[Glass|glass]], and [[Ice|ice]] — and [[Farmland|farmland]],
...
sky counts as fully lit at midnight exactly as at noon.
